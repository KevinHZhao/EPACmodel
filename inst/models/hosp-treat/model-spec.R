...
flows <- list(
  ...
  macpan2::mp_per_capita_inflow("I_A", "T", "admission_to_A_R", "T_AR"),
  macpan2::mp_per_capita_inflow("I_A", "T", "admission_to_A_CR", "T_ACR"),
  macpan2::mp_per_capita_inflow("I_A", "T", "admission_to_A_CD", "T_ACD"),
  macpan2::mp_per_capita_inflow("I_A", "T", "admission_to_A_D", "T_AD"),
