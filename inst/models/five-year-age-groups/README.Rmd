...
- `prog`: movement from $E$ to $I$, number of exposed from each age group becoming infectious
- `hosp`: movement from $I$ to $H$, number of infectious from each age group becoming hospitalized
- `disch`: movement from $H$ to $R$, number of hospitalized from each age group recovering
- `rec`: movement from $I$ to $R$, number of infectious from each age group recovering
- `d_H`: movement from $H$ to $D$, number of hospitalized from each age group dying
